export const targetTestEvidence = Object.freeze({
  ...
  pyto: {
    ...
    observations: [
      ...
      {
        run: 3,
        successSamples: {"1.1.1.1": 0, "1.0.0.1": 0, "9.9.9.9": 0, "149.112.112.112": 0, "8.8.8.8": 0, "8.8.4.4": 0},
        errors: {"1.1.1.1": 10, "1.0.0.1": 10, "9.9.9.9": 10, "149.112.112.112": 10, "8.8.8.8": 10, "8.8.4.4": 10}
      }
    ],
    notes: [
      "Three real iPhone/Pyto benchmark runs were recorded for example.com with 10 iterations per resolver and 5000ms timeout.",
      "The observed success rate changed between runs, including a third run with 0/10 successful samples for every tested resolver, so the current evidence is insufficient to claim stable resolver reachability or target compatibility.",
